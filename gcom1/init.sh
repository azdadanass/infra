...
azdad@$files_server_ip:/home/azdad/gcom/files /home/azdad/files    fuse.sshfs  defaults,_netdev,allow_other,default_permissions,identityfile=/home/USER/.ssh/id_rsa,uid=$UID,gid=$UID    0   0
